...
func init() {
	...
	managerCmd.PersistentFlags().StringSliceVar(&sbm.ExtraBundleCollectors, "extra-collectors", getEnvStringSlice("SUPPORT_BUNDLE_EXTRA_COLLECTORS"), "Get extra resource for the specific components e. e.g., Harvester")
}
